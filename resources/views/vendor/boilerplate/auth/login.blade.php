...
<div class="row v-center">
    <div class="col-md-6 justify-content-center d-inline-table text-right">
        @component('boilerplate::auth.loginbox')
            ...
            {!! Form::open(['route' => 'boilerplate.login', 'method' => 'post', 'autocomplete'=> 'off', 'class' => 'mt-3']) !!}
            @component('boilerplate::input', ['label' => 'boilerplate::users.email_address','name' => 'email', 'placeholder' => 'boilerplate::users.email_address_place_holder', 'type' => 'email'])@endcomponent
            @component('boilerplate::password', ['label' => 'Password', 'name' => 'password', 'placeholder' => 'boilerplate::auth.fields.password', 'check' => false])@endcomponent
            <div>
                <p class="mb-1 text-sm text-right">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <button type="submit" class="btn btn-primary btn-block mb-3 mt-4">@lang('boilerplate::auth.login.signin')</button>
            </div>
            {!! Form::close() !!}
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <p class="mb-1 text-sm">
                        @lang('boilerplate::auth.login.signup_label') <a href="javascript:;" disabled>Sign up</a><br>
                    </p>
