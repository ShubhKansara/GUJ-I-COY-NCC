            ...
            <table class="table table-striped table-hover va-middle" id="users-list">
                <thead>
                    <tr>
                        ...
                        <th>@lang('boilerplate::users.list.company_name')</th>
        ...
        $(function () {
            var oTable = $('#users-list').DataTable({
                ...
                fnInitComplete: function() {
                    $('#users-list_filter').append('<button class="btn btn-default btn-sm ml-2" data-widget="control-sidebar" data-slide="true"><span title="Filters" class="fa fa-filter"></span></button>')
                }
            });
